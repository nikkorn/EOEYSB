...
public class Pane extends ControlBase {
	...
	private PaneElementBorder paneElementBorder = null;
	private HashMap<Integer,Row> rowList = new HashMap<Integer,Row>();
	 ...
	 */
	public void addRow(Row row, int rowPosition){
	...
	public void organiseRows(){
		...
		ArrayList<Row> staticHeightRows = new ArrayList<Row>(); 
		ArrayList<Row> percentageHeightRows = new ArrayList<Row>();
		ArrayList<Row> stretchHeightRows = new ArrayList<Row>();
		...
		for(Row row : percentageHeightRows){
			float height = 0;
			float percentage = 0;
	...
	public PaneElementBorder getBorder() {
		return paneElementBorder;
	}

	public void setBorder(PaneElementBorder paneElementBorder) {
