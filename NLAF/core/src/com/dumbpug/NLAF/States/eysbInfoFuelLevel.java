 ...
 */
public class eysbInfoFuelLevel extends State {
    Pane pane;
    SpriteBatch batch;
    Sprite background;
    Animation fuelLevelAnimation;
    ...
    public void stateLoad() {
        ...
        fuelLevelAnimation = new Animation(new Texture(Gdx.files.internal("MiscImages/fuel_info_animation.png")), 1, 2, (float) 1/1f);
    ...
    public void renderState() {
        ...
        if(leftButton.isButtonReleased()){
            markStateChange(StateManager.STATE_EYSB_INFO_CONTROLS, true, true);
        }
        if(rightButton.isButtonReleased()){
            markStateChange(StateManager.STATE_EYSB_INFO_FUEL_PODS, true, true);
        }
