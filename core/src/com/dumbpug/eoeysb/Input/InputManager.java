...
import com.dumbpug.eoeysb.tools.ControlBase.ControlType;
				...
				for(ListenerControlLink link : activeLinks){
					...
					if(linkControl.isPointInActiveArea(posx, posy)){
						...
						if(linkControl.getControlType() == ControlType.BUTTON){
							com.dumbpug.eoeysb.tools.Button buttonControl = (com.dumbpug.eoeysb.tools.Button) linkControl;
	...
	public boolean touchDragged(int arg0, int arg1, int arg2) {
		...
		if(tempLink != null){
			...
			if(control.getControlType() == ControlType.BUTTON){
				com.dumbpug.eoeysb.tools.Button buttonControl = (com.dumbpug.eoeysb.tools.Button) control;
