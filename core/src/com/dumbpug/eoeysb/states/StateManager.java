...
import com.dumbpug.eoeysb.states.info.FuelLevel;
import com.dumbpug.eoeysb.states.info.FuelPods;
	...
	public void addState(int state){
		...
		if(!activeStates.containsKey(state)){
			...
			case STATE_TITLE:
				...
				break;
			case STATE_GAME:
				activeStates.put(state, new com.dumbpug.eoeysb.states.Game());
				break;
			case STATE_INFO_CONTROLS:
				activeStates.put(state, new com.dumbpug.eoeysb.states.info.Controls());
				break;
