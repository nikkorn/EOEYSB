...
import com.dumbpug.eoeysb.states.State;
import com.dumbpug.eoeysb.states.StateManager;
...
public class Controls extends State {
    ...
    SpriteBatch batch;
    Sprite background;
    com.dumbpug.eoeysb.tools.Animation controlsAnimation;
    ...
    public void stateLoad() {
        ...
        controlsAnimation = new com.dumbpug.eoeysb.tools.Animation(new Texture(Gdx.files.internal("MiscImages/controls_animation.png")), 1, 2, (float) 1/1f);
