...
public class StateManager {
	...
	public static int STATE_EYSB_INFO_CONTROLS = 5;
    public static int STATE_EYSB_INFO_FUEL_LEVEL = 6;
    public static int STATE_EYSB_INFO_FUEL_PODS = 7;
	//----------------------------------------------------------
	// State ID's (When creating a new state, add an entry here)
	//----------------------------------------------------------
	...
	public void addState(int state){
		...
		if(!activeStates.containsKey(state)){
			...
			case 4:
				...
				break;
			case 5:
				activeStates.put(state, new eysbInfoControls());
				break;
            case 6:
                activeStates.put(state, new eysbInfoFuelLevel());
                break;
            case 7:
                activeStates.put(state, new eysbInfoFuelPods());
                break;
