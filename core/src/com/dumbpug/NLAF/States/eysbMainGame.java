...
import com.dumbpug.NLAF.Entities.EntityManager;
import com.dumbpug.NLAF.Game;
...
import static com.dumbpug.NLAF.Game.getHighScore;

public class eysbMainGame extends State {
	...
	public void renderState() {
        ...
        if(inProgress) {
            ...
            if(resultPanel.exitRequested()){
                ...
                markStateChange(StateManager.STATE_EYSB_MAINGAME, true, true);
            }
            // Only generate clouds at a certain height
            if(testVertViewHeight > (Gdx.graphics.getHeight()*1.5) && getSkyHeightPercentage() < 50){
                cloudGenerator.generateCloud();
