package com.dumbpug.NLAF.panel;
...
public class ResultPanel extends Pane {
    ...
    public ResultPanel() {
        ...
        Column retryControlColumn = new Column();
        retryControlColumn.setControl(retryButton, Column.ControlOrientation.CENTER);
        retryControlColumn.columnWidth = "*";
        Column exitControlColumn = new Column();
        exitControlColumn.setControl(exitButton, Column.ControlOrientation.CENTER);
    ...
    public void show() {
        this.isShowing = true;
        this.currentInputManager = new InputManager();
