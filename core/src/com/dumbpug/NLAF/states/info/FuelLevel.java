 ...
 */
public class FuelLevel extends State {
    Pane pane;
    SpriteBatch batch;
    Sprite background;
    ...
    public void renderState() {
        ...
        if(leftButton.isButtonReleased()){
            markStateChange(StateManager.STATE_INFO_CONTROLS, true, true);
        }
        if(rightButton.isButtonReleased()){
            markStateChange(StateManager.STATE_INFO_FUEL_PODS, true, true);
        }
